...
#define M_BATT_MEAS_DEFAULT_POLL_INTERVAL 1234 // [ms]
...
#define M_BATT_MEAS_BATTERY_TYPE M_BATT_MEAS_TYPE_ALKALINE_AAA_2x_SERIES /** The battery type used */
    ...
    #define M_BATT_MEAS_MIN_LEVEL 1800  /** Which voltage is considered to be 0% battery level [mV] */
    #define M_BATT_MEAS_MAX_LEVEL 3200 /** Which voltage is considered to be 100% battery level [mV] */
#else
